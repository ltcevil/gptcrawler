...
## [Code without errors doesn’t work](#id3)
...
## [How can I except FloodWaitError?](#id4)
...
## [My account was deleted/limited when using the library](#id5)
...
## [AttributeError: ‘coroutine’ object has no attribute ‘id’](#id8)
...
## [sqlite3.OperationalError: database is locked](#id9)
...
## [event.chat or event.sender is None](#id10)
...
## [File download is slow or sending files takes too long](#id11)
...
## [What does “Server sent a very new message with ID” mean?](#id12)
...
## [What does “Server replied with a wrong session ID” mean?](#id13)
...
## [What does “Could not find a matching Constructor ID for the TLObject” mean?](#id14)
...
## [What does “Task was destroyed but it is pending” mean?](#id15)
...
## [What does “The asyncio event loop must not change after connection” mean?](#id16)
...
## [What does “bases ChatGetter” mean?](#id17)
...
## [Can I use Flask with the library?](#id19)
...
## [Can I use Anaconda/Spyder/IPython with the library?](#id20)
